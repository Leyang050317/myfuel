...
class _AddVehiclePageState extends State<AddVehiclePage> {
  ...
  static const Map<String, List<String>> _modelsByBrand = {
    ...
    'Proton': ['Saga', 'Persona', 'Iriz', 'S70', 'X50', 'X70', 'X90'],
    'Toyota': [
      'Vios',
      'Yaris',
      'Corolla Altis',
    ...
    'Nissan': ['Almera', 'Serena', 'Navara', 'X-Trail', 'NV200', 'Urvan'],
    'Mitsubishi': ['Triton', 'Xpander', 'Outlander', 'Pajero Sport'],
    ...
    'Kia': ['Picanto', 'Cerato', 'Seltos', 'Sportage', 'Sorento', 'Carnival'],
  ...
  Future<void> _saveVehicle() async {
    ...
    try {
      ...
      Navigator.of(context).pushReplacementNamed(AppRoutes.manageVehicles);
  ...
  Widget build(BuildContext context) {
    ...
    return AdminShell(
      title: 'Add Vehicle',
      selectedRoute: AppRoutes.addVehicle,
      child: Form(
        key: _formKey,
        child: ListView(
